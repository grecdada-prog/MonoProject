...
@section('page-title', 'Mon Historique d\'Activité')
...
<div class="max-w-7xl mx-auto">
    ...
    <div class="flex items-center justify-between mb-8">
        <div>
            <h2 class="text-3xl font-bold text-gray-900">Mon Historique d'Activité</h2>
            <p class="text-gray-600 mt-1">Journal de toutes mes actions effectuées</p>
        </div>

        <div class="flex items-center gap-3">
            <a href="{{ route('vendeur.activity.export.pdf') }}"
            ...
            <a href="{{ route('vendeur.activity.export.excel') }}"
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6">
        <form method="GET" class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="md:col-span-3 flex items-center gap-2">
                ...
                <a href="{{ route('vendeur.activity.index') }}"
        ...
        <div class="p-6">
            ...
            <div class="flex gap-4 pb-6 {{ !$loop->last ? 'border-b border-gray-200 mb-6' : '' }}">
                <div class="flex-shrink-0">
                    <div class="w-12 h-12 bg-gradient-to-br from-blue-500 to-blue-600 rounded-full flex items-center justify-center text-white font-bold shadow">
                ...
                <div class="flex-1 min-w-0">
                    <div class="flex items-start justify-between gap-4 mb-2">
                        <div>
                            ...
                            <p class="text-sm text-blue-600 font-medium">Vendeur</p>
                        </div>
