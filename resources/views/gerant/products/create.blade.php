...
<div class="max-w-4xl mx-auto">
    ...
    <div class="flex items-center justify-between mb-8">
        <div>
            <h2 class="text-3xl font-bold text-gray-900">Nouveau Produit</h2>
            <p class="text-gray-600 mt-1">Ajoutez un nouveau produit à votre inventaire</p>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="p-8">
            <form method="POST" action="{{ route('gerant.products.store') }}" id="createProductForm">
                @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label for="current_stock" class="block text-sm font-semibold text-gray-700 mb-2">
                                Stock initial <span class="text-red-600">*</span>
                            </label>
                            <input type="number"
                                   id="current_stock"
                                   name="current_stock"
                                   ...
                                   required
                                   min="0"
                                   class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent transition @error('current_stock') border-red-500 @enderror"
                                   placeholder="0">
                            @error('current_stock')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                            <p class="mt-1 text-xs text-gray-500">Quantité disponible en stock</p>
                        </div>
                    ...
                    <div class="flex gap-3">
                        ...
                        <div class="text-sm text-blue-800">
                            ...
                            <ul class="list-disc list-inside space-y-1">
                                <li>Le code SKU doit être unique</li>
                                <li>Un mouvement de stock sera créé automatiquement si le stock initial > 0</li>
                                <li>Vous recevrez une alerte lorsque le stock atteindra le seuil défini</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex items-center justify-end gap-4">
                    ...
                    <button type="button"
                            onclick="confirmAction(
                                'Créer le produit',
                                'Êtes-vous sûr de vouloir créer ce nouveau produit ?',
